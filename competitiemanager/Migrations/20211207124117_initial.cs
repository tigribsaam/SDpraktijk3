    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, 1, 0, 0, 1, new DateTime(2021, 12, 7, 13, 41, 16, 728, DateTimeKind.Local).AddTicks(5247), 0 });

            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameId", "AwayTeamId", "CompetitionId", "GoalsAway", "GoalsHome", "HomeTeamId", "StartDateAndTime", "Status" },
                values: new object[] { 2, 1, 1, 0, 0, 2, new DateTime(2021, 12, 7, 13, 41, 16, 736, DateTimeKind.Local).AddTicks(9590), 0 });

            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameId", "AwayTeamId", "CompetitionId", "GoalsAway", "GoalsHome", "HomeTeamId", "StartDateAndTime", "Status" },
                values: new object[] { 3, 1, 2, 3, 0, 2, new DateTime(2021, 12, 7, 13, 41, 16, 736, DateTimeKind.Local).AddTicks(9722), 3 });
